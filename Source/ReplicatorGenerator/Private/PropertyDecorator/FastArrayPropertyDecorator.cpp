...
FString FFastArrayPropertyDecorator::GetDefinition_ProtoField(int32& FieldNumber)
{
	FString Result = FPropertyDecorator::GetDefinition_ProtoField(FieldNumber);
	Result += FString::Printf( TEXT(";\n%s %s %s = %d"),
		*GetProtoFieldRule(), *GetProtoFieldType(), *GetFullUpdateProtoFieldName(), FieldNumber
	);
	FieldNumber++;
	return Result;
}

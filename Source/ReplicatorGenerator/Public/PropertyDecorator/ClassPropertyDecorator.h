...
public:
	...
	: FPropertyDecorator(InProperty, InOwner)
	{
		...
		constexpr int32 CLASS_NAME_POSTFIX_LENGTH = 13;
#else
		constexpr int32 CLASS_NAME_POSTFIX_LENGTH = 14;
#endif
		InnerClassName = CPPType.Mid(12, CPPType.Len() - CLASS_NAME_POSTFIX_LENGTH);
	}

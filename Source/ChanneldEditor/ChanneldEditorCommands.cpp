...
void FChanneldEditorCommands::RegisterCommands()
{
	...
	UI_COMMAND(ToggleCompatibleRecompilationCommand, "Enable Compatible Recompilation", "Turn on to enable recompilation after generating replication code", EUserInterfaceActionType::ToggleButton, FInputChord());
